...
private function getProductsByCategory(string $categoryName): array
{
    ...
    {
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Student']);
        $products = $productRepository->findBy(['category' => $category]);
    ...
    public function iphoneindex(ProductRepository $productRepository): Response
    {
        ...
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Children']);
        $products = $productRepository->findBy(['category' => $category]);
    ...
    {
        // Lấy danh sách sản phẩm của category "macbook"
        $category = $this->entityManager->getRepository(Category::class)->findOneBy(['name' => 'Adult']);
        $products = $productRepository->findBy(['category' => $category]);
